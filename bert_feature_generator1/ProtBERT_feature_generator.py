...
def generate_protbert_features(file):
    path = 'D:/fengzhen/MFEPre/bert_feature_generator/'
    t0=time()
    ...
    pickle.dump(all_protein_features, open('../data_cache/74_encode_data.pkl', 'wb'))
...
if __name__ == "__main__":
    ...
    file =  'D:/fengzhen/data/data_cache/422_name_seq_label_74.csv'
